...
# Load Images
mole_base = pygame.image.load("games/whack-a-mole/assets/base1.png")
mole_images = [
    # pygame.image.load("games/whack-a-mole/assets/base1.png").convert_alpha(),
    pygame.image.load("games/whack-a-mole/assets/mole1.png").convert_alpha(),
    pygame.image.load("games/whack-a-mole/assets/mole2.png").convert_alpha(),
    pygame.image.load("games/whack-a-mole/assets/mole3.png").convert_alpha()
]
menu_images = pygame.image.load("games/whack-a-mole/assets/menu.jpeg")
palu_images = [
    pygame.image.load("games/whack-a-mole/assets/palu1.png").convert_alpha(),
    pygame.image.load("games/whack-a-mole/assets/palu2.png").convert_alpha(),
]
background_image = pygame.image.load("games/whack-a-mole/assets/back2.jpeg")
