...
class MainMenu(Menu):
    ...
    def about_screen(self):
        ...
        instructions_text = [
            ...
            "",
            "Instructions:",
            "- Use the D key to move the character.",
            "- pick spells to cast using NUM KEYS",
            "- Take into considertation the Monsters elements immunty!!!",
...
class GameOverMenu(Menu):
    def __init__(self, screen, play_again):
        ...
        play_again_button = MenuButton(button_x, play_again_button_y, "on/again_on.png", "off/again_off.png", play_again, self.exit_menu)
        quit_button = MenuButton(button_x, quit_button_y, "on/quit_on.png", "off/quit_off.png", self.quit, self.exit_menu)
